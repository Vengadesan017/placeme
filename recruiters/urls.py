...
urlpatterns = [
    ...
    path('candidate/', views.Candidate,name='candidate_without_uuid'),
    path('applicant/', views.Applicant,name='applicant_without_uuid'),
    path('candidate/<uuid:candidate_uuid>/', views.Candidate,name='candidate'),
